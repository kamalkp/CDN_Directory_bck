...
//	fmt.Println("Type:", *typePtr)
	...
	TemplatePath = strconv.Itoa(*deviceIDPtr)+".conf"
...
func createCDN(){
	...
	configFileByte, err := ioutil.ReadFile("../template/template_with_flag.conf") // just pass the file name
	if err != nil {
		fmt.Print(err)
	}
...
func suspendCDN(){
	...
	err :=  os.Rename("/home/GoJSON/validation/"+TemplatePath, "/home/GoJSON/validation/suspend/"+TemplatePath+".suspend")
...
func unsuspendCDN(){
	...
	err :=  os.Rename("/home/GoJSON/validation/suspend/"+TemplatePath+".suspend", "/home/GoJSON/validation/"+TemplatePath)
...
func terminateCDN(){
	...
	err :=  os.Rename("/home/GoJSON/validation/"+TemplatePath, "/home/GoJSON/validation/terminate/"+TemplatePath+".terminate")
